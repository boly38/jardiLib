...
class JardiTerm {
  constructor() {
     ...
     jt.content = "";
     jt.history = ["lister"];
     jt.userCommands = ["lister","filtre","quitter"]
     jt.userCommandsLabels = ["^gl^:ister","^gf^:iltre","^gq^:uitter"]
     jt.adminCommands = ["contribuer","moderer","examiner"]
     jt.adminCommandsLabels = ["^gc^:ontribuer","^gm^:oderer","^ge^:xaminer"]
  ...
  contribuer() {
      ...
      jt.JardiFichiers.get({},(err, entries) => {
         entries.forEach((entry) => {
             asyncCalls.push((cb) => {
                jt.content += "\najout de la contribution [" + entry.nom + "]";
